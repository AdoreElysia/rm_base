 ...
 * @LastEditTime: 2025-12-08 18:19:41
 * @FilePath: /rm_base_demo/CONFIG/modules_config.h
 * @Description:
 */
...
#define OFFLINE_BEEP_OFF_TIME                                                                      \
    100 // 最大beep times（BEEP_PERIOD / （这里BEEP_ON_TIME + BEEP_OFF_TIME））
...
#define DM_IMU_CMD_READ_REG     0x01  // 达妙IMU请求命令帧头
