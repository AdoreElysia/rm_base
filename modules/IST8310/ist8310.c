...
IST8310_Instance_t *IST8310_Init()
{
    ...
    // 配置初始化参数（阻塞模式）
    I2C_Device_Init_Config config = {.hi2c        = &hi2c3,
    ...
    BSP_I2C_Mem_Write_Read(ist8310_instance.i2c_device, IST8310_WHO_AM_I, I2C_MEMADD_SIZE_8BIT,
                           &check_who_i_am, 1, 0);
    ...
    { // 写入配置,写一句就读一下
        BSP_I2C_Mem_Write_Read(ist8310_instance.i2c_device, ist8310_write_reg_data_error[i][0],
                               I2C_MEMADD_SIZE_8BIT, &ist8310_write_reg_data_error[i][1], 1, 1);
        BSP_I2C_Mem_Write_Read(ist8310_instance.i2c_device, ist8310_write_reg_data_error[i][0],
                               I2C_MEMADD_SIZE_8BIT, &check_who_i_am, 1, 0);
...
osal_status_t IST8310_ReadData(IST8310_Instance_t *ist)
{
    ...
    status               = BSP_I2C_Mem_Write_Read(ist8310_instance.i2c_device, IST8310_DATA_REG,
                                                  I2C_MEMADD_SIZE_8BIT, ist8310_instance.iic_buffer, 6, 0);
