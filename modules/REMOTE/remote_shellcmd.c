...
void remote_shell_cmd(int argc, char **argv)
{
    ...
    else if (strcmp(argv[1], "mouse") == 0)
    {
        ...
        if (vt_mouse != NULL)
        {
            ...
            shell_module_printf("    X: %d, Y: %d, Z: %d\r\n", vt_mouse->mouse_x, vt_mouse->mouse_y,
                                vt_mouse->mouse_z);
            shell_module_printf("    Left: %d, Right: %d, Middle: %d\r\n", vt_mouse->mouse_l,
                                vt_mouse->mouse_r, vt_mouse->mouse_m);
        }
        else
        {
    ...
    else if (strcmp(argv[1], "keyboard") == 0)
    {
        ...
        if (keyboard != NULL)
        {
            ...
            shell_module_printf("    W: %d, S: %d, A: %d, D: %d\r\n", keyboard->bit.KEY_W,
                                keyboard->bit.KEY_S, keyboard->bit.KEY_A, keyboard->bit.KEY_D);
            shell_module_printf("    SHIFT: %d, CTRL: %d, Q: %d, E: %d\r\n",
                                keyboard->bit.KEY_SHIFT, keyboard->bit.KEY_CTRL,
                                keyboard->bit.KEY_Q, keyboard->bit.KEY_E);
            shell_module_printf("    R: %d, F: %d, G: %d, Z: %d\r\n", keyboard->bit.KEY_R,
                                keyboard->bit.KEY_F, keyboard->bit.KEY_G, keyboard->bit.KEY_Z);
            shell_module_printf("    X: %d, C: %d, V: %d, B: %d\r\n", keyboard->bit.KEY_X,
                                keyboard->bit.KEY_C, keyboard->bit.KEY_V, keyboard->bit.KEY_B);
        }
        else
        {
            shell_module_printf("  Main Remote: No data\r\n");
        ...
        if (vt_keyboard != NULL)
        {
            ...
            shell_module_printf("    W: %d, S: %d, A: %d, D: %d\r\n", vt_keyboard->bit.KEY_W,
                                vt_keyboard->bit.KEY_S, vt_keyboard->bit.KEY_A,
                                vt_keyboard->bit.KEY_D);
            shell_module_printf("    SHIFT: %d, CTRL: %d, Q: %d, E: %d\r\n",
                                vt_keyboard->bit.KEY_SHIFT, vt_keyboard->bit.KEY_CTRL,
                                vt_keyboard->bit.KEY_Q, vt_keyboard->bit.KEY_E);
            shell_module_printf("    R: %d, F: %d, G: %d, Z: %d\r\n", vt_keyboard->bit.KEY_R,
                                vt_keyboard->bit.KEY_F, vt_keyboard->bit.KEY_G,
                                vt_keyboard->bit.KEY_Z);
            shell_module_printf("    X: %d, C: %d, V: %d, B: %d\r\n", vt_keyboard->bit.KEY_X,
                                vt_keyboard->bit.KEY_C, vt_keyboard->bit.KEY_V,
                                vt_keyboard->bit.KEY_B);
        }
        else
        {
            shell_module_printf("  VT Remote: No data\r\n");
