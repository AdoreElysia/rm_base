...
// 日志级别字符串
static const char *log_level_strings[] = {"VERBOSE", "DEBUG", "INFO", "WARN", "ERROR", "ASSERT"};
...
// 日志级别对应的颜色
static const char *log_level_colors[] = {COLOR_VERBOSE, COLOR_DEBUG, COLOR_INFO,
                                         COLOR_WARN,    COLOR_ERROR, COLOR_ASSERT};
...
static char *get_dwt_timestamp(void)
{
    ...
    snprintf(timestamp_str, sizeof(timestamp_str), "[%lu.%06lu]", (unsigned long)(us / 1000000),
