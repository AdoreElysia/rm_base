                                 ...
                                 osal_thread_priority_t priority)
{
    ...
    result = tx_thread_create((TX_THREAD *)thread, (CHAR *)name, (VOID(*)(ULONG))entry,
                              (ULONG)argument, (VOID *)stack_pointer, stack_size, priority,
                              priority, TX_NO_TIME_SLICE, TX_DONT_START);
                                 ...
                                 osal_thread_priority_t priority)
{
    ...
    thread->task_handle =
        xTaskCreateStatic((TaskFunction_t)entry, name, stack_size / sizeof(StackType_t), argument,
                          priority, (StackType_t *)stack_pointer, &thread->task_buffer);
